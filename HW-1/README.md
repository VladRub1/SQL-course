...
Банк специализируется в области банковских и финансовых услуг, 
...
2. Снижение риска ошибок и повышение точности данных за счет 
   автоматизации и стандартизации процессов.
3. Повышение безопасности хранения и обработки данных.
...
* Ввести данные об открытии нового валютного счета в фунтах стерлингов клиентов 
...
* _Транзакция 1._ Посчитать остаток по всем счетам клиента, включая кредитный лимит, 
  с переводом валютных счетов в рубли по курсу ЦБ 
...
* _Транзакция 6._ Сформировать поквартальные отчеты о средней ставке по выдаваемым 
  кредитам и комиссиям за переводы и соответствующим им процентном (от кредитов) и транзакционном (за комиссии от операций) доходах для руководства в целях аналитики 
...
* База данных банка должна быть надежно защищена с использованием паролей и 
  ...
  контролю. БД должна быть защищена паролем и различными уровнями доступа. 
* Максимальный доступ к данным предоставляется исключительно представителям 
  ...
  более ограниченные права доступа, позволяющие просматривать обобщенную 
